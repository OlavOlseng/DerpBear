...
public class NetworkReadSystem extends BaseSystem {
	 ...
	 *            how often the socket will be read
	 */
	public NetworkReadSystem(EntityManager entityManager,
			EntityFactory entityFactory, Connection client) {
	...
	public void update(float dt) {
		...
		for (Syncable syncable : components) {
			...
			((Syncable) manager.getComponentOfClassForEntity(
					component.getClass(), entity)).onRead(component);
